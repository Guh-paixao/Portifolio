    ...
    return (
        <div className="flex flex-1 ml-48 2xl:ml-52 items-center">
            <div className="flex flex-row items-start gap-8 2xl:gap-10">
                <div className="flex flex-col bg-white 2xl:w-[230px] h-80 mt-2 border-t-4 items-center justify-center select-none p-4 pt-4 2xl:gap-4 gap-2 border-zinc-600 border-2 dark:border-0">
