    ...
    return (
        <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-4">
                ...
                <h1 className="font-poppins text-4xl font-light text-dark dark:text-white tracking-[.10em]">Eu sou/I’Am <br /><span className="font-bold text-5xl font-poppins tracking-[.20em]">Gustavo Paixão|</span></h1>
            </div>
            <div>
